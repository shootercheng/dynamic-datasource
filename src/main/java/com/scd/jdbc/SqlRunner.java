...
public class SqlRunner {
    ...
    public void executeLineByLine(Reader reader) {
    ...
    public void executeLineByLine(Reader reader, String dbTemplate, String dbName) {
        StringBuilder command = new StringBuilder();
        try {
            BufferedReader lineReader = new BufferedReader(reader);
            String line;
            while ((line = lineReader.readLine()) != null) {
                if (line.contains(dbTemplate)) {
                    line = line.replace(dbTemplate, dbName);
                }
                handleLine(command, line);
            }
            commitConnection();
